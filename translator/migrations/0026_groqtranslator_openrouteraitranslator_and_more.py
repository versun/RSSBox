        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "translate_prompt",
                    models.TextField(
                        default="Translate only the text into {target_language},only returns translations."
                    ),
                ),
                ...
                (
                    "base_url",
                    models.URLField(
                        default="https://api.groq.com/openai/v1", verbose_name="API URL"
                    ),
                ),
                (
                    "model",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "base_url",
                    models.URLField(
                        default="https://openrouter.ai/api/v1", verbose_name="API URL"
                    ),
                ),
                (
                    "model",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "base_url",
                    models.URLField(
                        default="https://api.together.xyz/v1", verbose_name="API URL"
                    ),
                ),
                (
                    "model",
