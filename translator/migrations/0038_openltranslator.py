    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "url",
                    models.URLField(default="https://api.openl.club", max_length=255),
                ),
                (
                    "service_name",
                    models.CharField(
                        default="deepl",
                        help_text="Please get it from https://docs.openl.club/#/API/format?id=%e7%bf%bb%e8%af%91%e6%9c%8d%e5%8a%a1%e4%bb%a3%e7%a0%81%e5%90%8d",
                        max_length=50,
                        verbose_name="Translate Service Name",
                    ),
                ),
