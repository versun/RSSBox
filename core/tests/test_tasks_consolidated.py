...
class TasksConsolidatedTestCase(TestCase):
    ...
    @patch("core.tasks.convert_struct_time_to_datetime")
    @patch("core.tasks.fetch_feed")
    def test_handle_single_feed_fetch_content_fallback(self, mock_fetch_feed, mock_convert_time):
    ...
    def test_translate_title_already_translated(self):
        ...
        second_metrics = _translate_title(entry, target_language="Chinese", engine=agent)
    ...
    def test_translate_content_with_skip_elements(self, mock_auto_retry, mock_text_handler):
