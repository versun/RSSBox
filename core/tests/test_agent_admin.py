...
class AgentAdminTest(TestCase):
    ...
    def test_masked_api_key(self):
        ...
        deepl_agent = DeepLAgent.objects.create(name="Test DeepL", api_key="token-1234567890")
    ...
    def test_is_valid(self):
        ...
        test_cases = [(True, status_icon(True)), (False, status_icon(False)), (None, status_icon(None))]
