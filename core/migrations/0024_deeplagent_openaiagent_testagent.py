    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "server_url",
                    models.URLField(
                        blank=True, null=True, verbose_name="API URL(optional)"
                    ),
                ),
                (
                    "proxy",
                    models.URLField(
                        blank=True, null=True, verbose_name="Proxy(optional)"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="Maximum requests per minute (0 = no limit)",
                        verbose_name="Rate Limit (RPM)",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "interval",
                    models.IntegerField(default=3, verbose_name="Request Interval(s)"),
                ),
                ("is_ai", models.BooleanField(default=True, editable=False)),
            ],
            options={
