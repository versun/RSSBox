        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Name of the digest (e.g., 'Tech Daily', 'Weekly Summary')",
                        max_length=200,
                        verbose_name="Name",
                    ),
                ),
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Optional description of what this digest covers",
                ...
                (
                    ...
                    models.BooleanField(
                        editable=False,
                        help_text="Whether the last generation was successful",
                        null=True,
                ...
                (
                    ...
                    models.IntegerField(
                        default=1,
                        help_text="Number of days to look back for articles (1 = today only, 7 = past week)",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text="Language of the generated digest output",
                        max_length=50,
                ...
                (
                    ...
                    models.TextField(
                        ...
                        help_text="AI prompt for generating digest content. Use {digest_name}, {date}, {target_language} as placeholders",
                        verbose_name="Prompt",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Whether this digest should be automatically generated",
                        verbose_name="Active",
                    ),
                ),
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="When this digest was last generated",
                        null=True,
                ...
                (
                    ...
                    models.JSONField(
                        default=list,
                        help_text="Days of week to publish (e.g., ['monday', 'tuesday', 'friday'])",
                        verbose_name="Publish Days",
                    ),
                ),
                (
                    "created_at",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        default="",
                        help_text="Log for the digest, useful for debugging",
                        null=True,
                        verbose_name="Log",
                    ),
                ),
                ...
                (
                    "summarizer",
                    models.ForeignKey(
                        help_text="OpenAI agent to use for generating digest content (only valid agents are shown)",
                ...
                (
                    ...
                    models.ManyToManyField(
                        help_text="Tags to include in this digest. Articles from feeds with these tags will be processed",
